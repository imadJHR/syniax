...
import { ArrowLeft, Shield, Zap, Camera, Lock, Smartphone, Users, Eye, CheckCircle, Award, Clock, Wifi, Battery, Star, ArrowRight } from "lucide-react"
...
export default function FeaturesPage() {
  ...
  const seoContent = {
    fr: {
      ...
      description: "Syniax intègre les dernières innovations en sécurité électronique : IA, surveillance 24/7, contrôles d'accès intelligents et bien plus encore.",
      features: [
        {
          icon: Shield,
          title: "Surveillance 24/7 Intelligente",
          description: "Monitoring continu avec analyse IA pour détecter les menaces en temps réel et interventions automatiques.",
        ...
        },
        {
          ...
          description: "Caméras haute définition avec reconnaissance faciale, analyse comportementale et vision nocturne avancée.",
          stats: "4K Ultra HD",
        ...
        },
        {
          ...
          description: "Systèmes d'authentification biométrique, badges sécurisés et gestion centralisée des permissions.",
        ...
        },
        {
          ...
          description: "Systèmes UPS avec autonomie prolongée et basculement automatique pour une protection sans interruption.",
        ...
        },
        {
          ...
          description: "Application mobile sécurisée pour contrôler tous vos systèmes de sécurité depuis n'importe où.",
          stats: "iOS & Android",
        ...
        },
        {
          ...
          description: "Équipe de spécialistes disponible en permanence pour assistance technique et interventions d'urgence.",
        ...
        },
        {
          ...
          description: "Intelligence artificielle avancée pour anticiper les risques et optimiser votre sécurité proactive.",
        ...
        },
        {
          ...
          description: "Infrastructure réseau cryptée avec connexions redondantes pour une fiabilité maximale.",
          stats: "99.99% uptime",
        ...
        },
        {
          ...
          description: "Systèmes conformes aux normes les plus strictes : ISO 27001, GDPR, ANSSI et certifications européennes.",
      ...
      technologies: [
        {
          ...
          description: "Algorithmes d'IA propriétaires pour une détection avancée des menaces"
        },
        {
          name: "Cloud Sécurisé",
          description: "Infrastructure cloud certifiée avec chiffrement de bout en bout"
        },
        {
          name: "IoT Sécurisé",
          description: "Appareils connectés avec protocoles de sécurité avancés"
        },
        {
          name: "Blockchain",
          description: "Technologie blockchain pour l'intégrité des données et audits"
        }
      ]
    },
    en: {
      ...
      description: "Syniax integrates the latest innovations in electronic security: AI, 24/7 monitoring, smart access controls and much more.",
      features: [
        {
          icon: Shield,
          title: "Intelligent 24/7 Monitoring",
          description: "Continuous monitoring with AI analysis to detect threats in real-time and automatic interventions.",
        ...
        },
        {
          ...
          description: "High-definition cameras with facial recognition, behavioral analysis and advanced night vision.",
          stats: "4K Ultra HD",
        ...
        },
        {
          ...
          description: "Biometric authentication systems, secure badges and centralized permission management.",
        ...
        },
        {
          ...
          description: "UPS systems with extended autonomy and automatic switching for uninterrupted protection.",
          stats: "72h autonomy",
        ...
        },
        {
          ...
          description: "Secure mobile application to control all your security systems from anywhere.",
          stats: "iOS & Android",
        ...
        },
        {
          ...
          description: "Team of specialists available permanently for technical assistance and emergency interventions.",
        ...
        },
        {
          ...
          description: "Advanced artificial intelligence to anticipate risks and optimize your proactive security.",
          stats: "95% accuracy",
        ...
        },
        {
          ...
          description: "Encrypted network infrastructure with redundant connections for maximum reliability.",
          stats: "99.99% uptime",
        ...
        },
        {
          ...
          description: "Systems compliant with the strictest standards: ISO 27001, GDPR, ANSSI and European certifications.",
          stats: "10+ certifications",
      ...
      technologies: [
        {
          ...
          description: "Proprietary AI algorithms for advanced threat detection"
        },
        {
          name: "Secure Cloud",
          description: "Certified cloud infrastructure with end-to-end encryption"
        },
        {
          name: "Secure IoT",
          description: "Connected devices with advanced security protocols"
        },
        {
          name: "Blockchain",
          description: "Blockchain technology for data integrity and audits"
        }
      ]
    }
  }
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        >
          ...
          <motion.h2 
            ...
            transition={{ delay: 0.2 }}
          >
            {language === "fr" ? "Prêt à renforcer votre sécurité ?" : "Ready to enhance your security?"}
          </motion.h2>
          ...
          >
            ...
            >
              ...
              <Link href="/contact">{language === "fr" ? "Démo Gratuite" : "Free Demo"}</Link>
            </motion.button>
            ...
            >
              ...
              <Link href="/services">{language === "fr" ? "Voir nos Services" : "View Services"}</Link>
            </motion.button>
          </motion.div>
        </motion.div>
      </section>
